...
extern void *mono_aot_module_SqliteWasmHelper_info;
extern void *mono_aot_module_System_Diagnostics_DiagnosticSource_info;
extern void *mono_aot_module_Test_info;
...
void register_aot_modules ()
{
	...
	mono_aot_register_module (mono_aot_module_SqliteWasmHelper_info);
	mono_aot_register_module (mono_aot_module_System_Diagnostics_DiagnosticSource_info);
	mono_aot_register_module (mono_aot_module_Test_info);
